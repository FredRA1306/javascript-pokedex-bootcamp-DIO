            ...
            <table>
              <tr>
                ...
                <td class="stat-gauge" colspan="2">
                  <div class="gauge">
                    <div class="${
                      pokemon.baseStats.hp > 50 ? "fill-green" : "fill-red"
                    }" style="width: ${pokemon.baseStats.hp - 20}%;"></div>
                  </div>
                </td>
              ...
              <tr>
                ...
                <td class="stat-gauge" colspan="2">
                  <div class="gauge">
                    <div class="${
                      pokemon.baseStats.attack > 50 ? "fill-green" : "fill-red"
                    }" style="width: ${pokemon.baseStats.attack - 20}%;"></div>
                  </div>
                </td>
              </tr>
              <tr>
                ...
                <td class="stat-gauge" colspan="2">
                  <div class="gauge">
                    <div class="${
                      pokemon.baseStats.defense > 50 ? "fill-green" : "fill-red"
                    }" style="width: ${pokemon.baseStats.defense - 20}%;"></div>
                  </div>
                </td>
              </tr>
              <tr>
                ...
                <td class="stat-gauge" colspan="2">
                  <div class="gauge">
                    <div class="${
                      pokemon.baseStats.specialAttack > 50
                        ? "fill-green"
                        : "fill-red"
                    }" style="width: ${
        pokemon.baseStats.specialAttack - 20
      }%;"></div>
                  </div>
                </td>
              </tr>
              <tr>
                ...
                <td class="stat-gauge" colspan="2">
                  <div class="gauge">
                    <div class="${
                      pokemon.baseStats.specialDefense > 50
                        ? "fill-green"
                        : "fill-red"
                    }" style="width: ${
        pokemon.baseStats.specialDefense - 20
      }%;"></div>
                  </div>
                </td>
              </tr>
              <tr>
                ...
                <td class="stat-gauge" colspan="2">
                  <div class="gauge">
                    <div class="${
                      pokemon.baseStats.speed > 50 ? "fill-green" : "fill-red"
                    }" style="width: ${pokemon.baseStats.speed - 20}%;"></div>
                  </div>
              </tr>
              <tr>
                <td>Total</td>
                ...
                <td class="stat-gauge" colspan="2">
                        <div class="gauge">
                            <div class="${
                              soma > 300 ? "fill-green" : "fill-red"
                            }" style="width: ${soma / 6}%;"></div>
                        </div>
              </tr>
            </table>
          </div>
